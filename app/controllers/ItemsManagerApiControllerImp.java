...
public class ItemsManagerApiControllerImp extends ItemsManagerApiControllerImpInterface {
    @Override
    public CFItemType getCFItem(Http.Request request, String sourcedId) throws Exception {
        //Do your magic!!!
        return new CFItemType();
    }
